...
type BillingSettingsFilterSectionProps = {
  gte: string;
...
const BillingSettingsFilterSection: React.FC<
  BillingSettingsFilterSectionProps
...
export default BillingSettingsFilterSection;
