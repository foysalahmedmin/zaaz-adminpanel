...
type PaymentMethodsFilterSectionProps = {
  gte: string;
...
const PaymentMethodsFilterSection: React.FC<
  PaymentMethodsFilterSectionProps
> = ({
  gte,
  setGte,
  lte,
...
export default PaymentMethodsFilterSection;
