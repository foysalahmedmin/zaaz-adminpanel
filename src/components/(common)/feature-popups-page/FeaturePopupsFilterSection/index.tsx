...
type FeaturePopupsFilterSectionProps = {
  gte: string;
...
const FeaturePopupsFilterSection: React.FC<FeaturePopupsFilterSectionProps> = ({
  gte,
  setGte,
  lte,
  setLte,
...
export default FeaturePopupsFilterSection;
