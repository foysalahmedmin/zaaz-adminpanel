...
type UserWalletsFilterSectionProps = {
  gte: string;
  ...
  packagesData?: { data?: TPackage[] };
  onReset: () => void;
};

const UserWalletsFilterSection: React.FC<UserWalletsFilterSectionProps> = ({
  gte,
  setGte,
  lte,
  setLte,
...
export default UserWalletsFilterSection;
